...
|OpenSO2| is open source software for controlling a scanning UV spectrometer to calculate volcanic |SO2| fluxes.
...
The |OpenSO2| system is designed to be open source and flexible. All software is writen in Python and the components are all commertially available, requiring only basic electronics understanding to build - indeed it is our hope that the volcanic gas community will work together to improve this beyond the groundwork laid out here!
...
To install |OpenSO2| simply clone the `git repositry <https://github.com/benjaminesse/open_so2>`_. This contains both the home computer and scanner station software 
